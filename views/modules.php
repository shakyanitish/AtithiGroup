...
$jVars['site:logo']			= '
                        ...
                        <a href="'.BASE_URL.'">
                            <picture>
                                <source media="(min-width:1024px)" srcset="'.IMAGE_PATH.'preference/'.$siteRegulars->logo_upload.'">
                                <img src="'.IMAGE_PATH.'preference/'.$siteRegulars->logo_upload.'" alt="logo" class="w-full h-full object-contain">
                            </picture>
