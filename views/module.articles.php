...
if (defined('HOME_PAGE')) {
    ...
    <section class="py-24 px-6 md:px-10 bg-background-light dark:bg-background-dark">
        <div class="max-w-4xl mx-auto text-center">
            <div class="inline-flex items-center gap-2 text-primary mb-6">
                <span class="h-px w-8 bg-primary/50"></span>
                <span class="uppercase tracking-widest text-xs font-bold">Our Philosophy</span>
                <span class="h-px w-8 bg-primary/50"></span>
            </div>
            <h2
                class="text-text-main dark:text-white font-serif text-[1.8rem] md:text-[2rem]  lg:text-[3rem] lg:leading-[1.5]  mb-10 italic">
                "'. $innRow->title .'"
            </h2>
            ' . $innRow->content . '
