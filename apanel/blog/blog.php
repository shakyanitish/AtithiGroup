        ...
        <div class="example-code">
            <form action="" class="col-md-12 center-margin" id="blog_frm">
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-6">
                        <input placeholder="Blog Sub Brief" class="col-md-6 validate[required,length[0,200]]"
                               type="text" name="short_brief" id="short_brief"
                               value="<?php echo !empty($blogInfo->short_brief) ? $blogInfo->short_brief : ""; ?>">
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-6">
                        <input placeholder="Blog Sub Title" class="col-md-6 validate[required,length[0,200]]"
                               type="text" name="sub_title" id="sub_title"
                               value="<?php echo !empty($blogInfo->sub_title) ? $blogInfo->sub_title : ""; ?>">
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-6">
                        <input placeholder="Read Time" class="col-md-6 validate[required,length[0,200]]"
                               type="text" name="read_time" id="read_time"
                               value="<?php echo !empty($blogInfo->read_time) ? $blogInfo->read_time : ""; ?>">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-label col-md-2">
                    ...
                    <div class="form-input col-md-6">
                        <input placeholder="Author Name" class="col-md-6 validate[required,length[0,200]]"
