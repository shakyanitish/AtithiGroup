...
class Blog extends DatabaseObject
{
    ...
    protected static $db_fields = array('id', 'slug', 'title', 'sub_title', 'author', 'brief', 'content', 'read_time', 'status', 'meta_keywords', 'meta_description', 'blog_date','linksrc','linktype', 'archive_date', 'sortorder', 'type', 'viewcount', 'added_date', 'image', 'source', 'short_brief');
